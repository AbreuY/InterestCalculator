...
public class Account {
	 ...
	 */
	public BigDecimal getTotoalBalance(int years){
		//首先进行输入年限的非负判断
		if(years <0)
	 ...
	 */
	public static BigDecimal getTotoalBalance(double inputBalance,double inputAnnualInterest,int years){
